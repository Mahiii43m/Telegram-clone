// src/screens/settings/MessageSettingsScreen.js
...
export default function MessageSettingsScreen({ navigation }) {
  ...
  const loadSettings = async () => {
    try {
      ...
      console.warn('Failed to load message settings', error);
    }
  };
  ...
  const saveSettings = async (newSettings) => {
    try {
      ...
      console.warn('Failed to save message settings', error);
    }
  };
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: bgColor }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={[styles.infoCard, { backgroundColor: cardColor, borderColor: borderColor }]}>
          <Ionicons name="chatbubble-ellipses-outline" size={18} color={goldAccent} style={styles.infoIcon} />
        ...
        <View style={[styles.card, { backgroundColor: cardColor, borderColor: borderColor }]}>
          ...
          >
            <View style={styles.optionLeft}>
              ...
              <Text style={[styles.optionText, { color: textColor }]}>Message Font Size</Text>
            </View>
